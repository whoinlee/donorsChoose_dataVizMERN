...
var BubbleChart = function (_Component) {
  ...
  function BubbleChart() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BubbleChart.__proto__ || Object.getPrototypeOf(BubbleChart)).call.apply(_ref, [this].concat(args))), _this), _this.loadChart = function (container) {
      ...
      helper.setProperties('renderHorizontalGridLines', 'renderVerticalGridLines', 'xAxisLabel', 'yAxisLabel', 'colorAccessor', 'keyAccessor', 'valueAccessor', 'radiusValueAccessor', 'x', 'y', 'r', 'colors', 'colorDomain');
...
BubbleChart.propTypes = {
  colorAccessor: _propTypes.func,
  keyAccessor: _propTypes.func,
  valueAccessor: _propTypes.func,
  radiusValueAccessor: _propTypes.func,
  x: _propTypes.func,
  y: _propTypes.func,
  r: _propTypes.func,
  colorDomain: _propTypes.array
};
